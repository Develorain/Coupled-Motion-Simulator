...
public class LeftWireModel extends WireModel {
    ...
    public void updatePosition() {
        ...
        leftStringRightCoord.setX(systemModelModeTwo.leftPulley.getTopLeftCorner().getX() + systemModelModeTwo.leftPulley.getRadius() - systemModelModeTwo.leftPulley.getRadius() * MathTools.sin(systemModelModeTwo.getLeftSlopeAngle()));
        leftStringRightCoord.setY(systemModelModeTwo.leftPulley.getTopLeftCorner().getY() + systemModelModeTwo.leftPulley.getRadius() - systemModelModeTwo.leftPulley.getRadius() * MathTools.cos(systemModelModeTwo.getLeftSlopeAngle()));

        rightStringLeftCoord.setX(systemModelModeTwo.leftPulley.getTopLeftCorner().getX() + systemModelModeTwo.leftPulley.getRadius());
        rightStringLeftCoord.setY(systemModelModeTwo.leftPulley.getTopLeftCorner().getY());
